...
void loop ()
{
  int num = lv_arc_get_value(ui_Arc2)-1;
  for(int j=12;j>num; j--)
  {
    leds[j] = CRGB::Black;
    FastLED.show();  
  }
  for(int i=0;i<=num;i++)
  {
    switch(num)
    {
      case 0:leds[i] = CRGB::DarkBlue; break;
      case 1:leds[i] = CRGB::Teal; break;
      case 2:leds[i] = CRGB::Orange; break;
      case 3:leds[i] = CRGB::White; break;
      case 4:leds[i] = CRGB::Green; break;
      case 5:leds[i] = CRGB::Aqua; break;
      case 6:leds[i] = CRGB::Red; break;
      case 7:leds[i] = CRGB::Pink; break;
      case 8:leds[i] = CRGB::Blue; break;
      case 9:leds[i] = CRGB::Maroon; break;
      case 10:leds[i] = CRGB::Yellow; break;
